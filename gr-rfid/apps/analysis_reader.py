...
class reader_top_block(gr.top_block):
  ...
  def __init__(self):
    ...
    if (DEBUG == False) : # Real Time Execution
      ...
      self.file_source               = blocks.file_source(gr.sizeof_gr_complex*1, "../misc/Corilateme/source",False)   ## instead of uhd.usrp_source
      self.file_sink                  = blocks.file_sink(gr.sizeof_gr_complex*1,   "../misc/Corilateme/file_sink", False)     ## instead of uhd.usrp_sink
